...
console.log('\nHelpful next steps:');
console.log('- Update scripts/fetch/ to include sources for metrics with many missing states');
console.log('- Use scripts/build_pack.mjs to re-run composition and then scripts/validate/validate-pack.mjs');
